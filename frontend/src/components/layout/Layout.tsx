...
import { Activity, BarChart3, Bot, Check, ChevronDown, FileText, Languages, Moon, Sun, Plus, Trash2, Pencil, MessageSquare, ChevronsLeft, ChevronsRight, Settings, Layers, Loader2, Radar } from "lucide-react";
...
export function Layout() {
  ...
  const NAV = [
    ...
    { to: "/scanner", icon: Radar, label: t('layout.scanner') },
